...
public class NotificationBadge {
    ...
    public static Context applicationContext = FirebaseMessagingPlugin.instance.cordova.getActivity().getApplicationContext();
    public static Handler applicationHandler = new Handler(applicationContext.getMainLooper());
    ...
    public static class AdwHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            if (canResolveBroadcast(intent)) {
                runOnUIThread(() -> applicationContext.sendBroadcast(intent));
            }
        }
    ...
    public static class HuaweiHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            localBundle.putString("package", applicationContext.getPackageName());
            localBundle.putString("class", componentName.getClassName());
            localBundle.putInt("badgenumber", badgeCount);
            runOnUIThread(() -> {
                try {
                    applicationContext.getContentResolver().call(Uri.parse("content://com.huawei.android.launcher.settings/badge/"), "change_badge", null, localBundle);
                } catch (Exception e) {
                    Log.e("FCMPluginService", "executeBadge", e);
                }
            });
        }
    ...
    public static class NovaHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            applicationContext.getContentResolver().insert(Uri.parse(CONTENT_URI), contentValues);
        }
    ...
    public static class OPPOHomeBader implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            try {
                ...
                applicationContext.getContentResolver().call(Uri.parse(PROVIDER_CONTENT_URI), "setAppBadgeCount", null, extras);
    ...
    public static class SonyHomeBadger implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            ...
            if (mQueryHandler == null) {
                mQueryHandler = new AsyncQueryHandler(applicationContext.getApplicationContext().getContentResolver()) {
        ...
        private static boolean sonyBadgeContentProviderExists() {
            ...
            ProviderInfo info = applicationContext.getPackageManager().resolveContentProvider(SONY_HOME_PROVIDER_NAME, 0);
            if (info != null) {
                exists = true;
            }
            return exists;
    ...
    public static class ZukHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            runOnUIThread(() -> {
                try {
                    applicationContext.getContentResolver().call(CONTENT_URI, "setAppBadgeCount", null, extra);
                } catch (Exception e) {
                    Log.e("FCMPluginService", "executeBadge", e);
                }
            });
    ...
    public static boolean applyCount(int badgeCount) {
        Log.i("FCMPluginService", "applyCount: " + String.valueOf(badgeCount));
        try {
